...
- [`Rectangle$set_depth()`](#method-Rectangle-set_depth)
...
Set the rectangle's rendering depth. Objects with a larger depth are
rendered in front of objects with a smaller depth.

#### Usage

    Rectangle$set_depth(depth)
...
This rectangle object, invisibly, to support method chaining.
