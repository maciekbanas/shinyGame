...
- [`StaticSprite$show()`](#method-StaticSprite-show)

- [`StaticSprite$hide()`](#method-StaticSprite-hide)
...
- [`StaticSprite$set_depth()`](#method-StaticSprite-set_depth)
...
Set the static sprite's rendering depth. Objects with a larger depth are
rendered in front of objects with a smaller depth.

#### Usage

    StaticSprite$set_depth(depth)
...
This static sprite object, invisibly, to support method chaining.
