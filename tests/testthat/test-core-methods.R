...
test_that("Sprite utility methods send expected JS", {
  ...
  s$set_in_motion_random_or_toward("mushroom_man", 300, 0, 1, 90, 45, lag = 0)
  s$destroy()
  ...
  expect_true(any(grepl('setSpriteInMotionRandomOrToward\\("hero", "mushroom_man", 300, 0, 1, 90, 45\\);', msgs)))
